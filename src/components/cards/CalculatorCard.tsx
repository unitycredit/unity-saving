    ...
    <Card className="overflow-hidden">
      <CardHeader>
        <div>
          ...
          <CardDescription>Sleek, dark-themed calculator.</CardDescription>
        </div>
      ...
      <CardContent>
        ...
        >
          ...
          <div className="mt-4 grid grid-cols-4 gap-2">
            <Key label="7" onClick={() => inputNumber("7")} />
            <Key label="8" onClick={() => inputNumber("8")} />
            <Key label="9" onClick={() => inputNumber("9")} />
            <Key label="÷" tone="op" onClick={() => chooseOperator("÷")} />

            <Key label="4" onClick={() => inputNumber("4")} />
            <Key label="5" onClick={() => inputNumber("5")} />
            <Key label="6" onClick={() => inputNumber("6")} />
            <Key label="×" tone="op" onClick={() => chooseOperator("×")} />

            <Key label="1" onClick={() => inputNumber("1")} />
            <Key label="2" onClick={() => inputNumber("2")} />
            <Key label="3" onClick={() => inputNumber("3")} />
            <Key label="-" tone="op" onClick={() => chooseOperator("-")} />

            <Key label="0" className="col-span-2" onClick={() => inputNumber("0")} />
            <Key label="." onClick={inputDot} />
            <Key label="+" tone="op" onClick={() => chooseOperator("+")} />

            <Key label="⌫" tone="soft" onClick={backspace} />
            <Key label="C" tone="soft" onClick={clearAll} />
            <Key label="=" className="col-span-2" tone="primary" onClick={equals} />
          </div>
        </div>
      </CardContent>
    </Card>
